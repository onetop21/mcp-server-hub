import { MarketplaceServer, MarketplaceServerCreate, MarketplaceServerUpdate } from '../../domain/models/MarketplaceServer';
...
export class MarketplaceRepository {
  ...
  async list(tags?: string[], search?: string): Promise<MarketplaceServer[]> {
  ...
  async findById(id: string): Promise<MarketplaceServer | null> {
    return this.servers.get(id) || null;
  }

  async create(data: MarketplaceServerCreate, createdBy: string): Promise<MarketplaceServer> {
  ...
  async update(id: string, updates: MarketplaceServerUpdate): Promise<MarketplaceServer> {
